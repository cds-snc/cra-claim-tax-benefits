...
const routes = [
  ...
  { path: '/login/securityQuestion', editInfo: 'skip' },
  { path: '/login/questions', options: ['/login/securityQuestion2'], editInfo: 'skip' },
  { path: '/login/questions', options: securityQuestionUrls, editInfo: 'skip' },
